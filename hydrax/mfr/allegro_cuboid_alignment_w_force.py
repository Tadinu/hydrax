...
# hydrax
from hydrax.mfr.allegro_env import MODELS_DIR, ALLEGRO_MODEL_DIR
...
class AllegroCuboidAlignment(AllegroValveTurning):
    ...
    def _init_contact_scenes(self, asset_object, collision_checking):
        ...
        robot_sdf = pv.RobotSDF(self.chain, path_prefix=ALLEGRO_MODEL_DIR, use_collision_geometry=True)
        ...
        viz_robot_sdf = pv.RobotSDF(self.chain, path_prefix=ALLEGRO_MODEL_DIR,
