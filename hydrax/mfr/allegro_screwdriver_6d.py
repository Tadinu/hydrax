...
# hydrax
from hydrax.mfr.utils.allegro_utils import partial_to_full_state, full_to_partial_state, state2ee_pos, \
    visualize_trajectory
from hydrax.mfr.allegro_valve_turning import AllegroValveTurning
from hydrax.mfr.allegro_screwdriver_env import AllegroScrewdriverEnv
from hydrax.mfr.allegro_env import AllegroContactProblem, PositionControlConstrainedSVGDMPC
...
def do_trial(env, params, fpath, sim_viz_env=None):
    ...
    if params['controller'] == 'csvgd':
        ...
        pregrasp_problem = AllegroContactProblem(
            ...
            object_model_path=self.env.cfg.object_model_path,
            object_location=params['object_location'],
            object_type=params['object_type'],
            world_trans=env.robot_init_transf,
            fingers=contact_fingers,
            obj_dof_code=env.obj_dof_code,
            obj_joint_dim=1,
            fixed_obj=True
        )
    ...
    for k in range(params['num_steps']):
        ...
        if params['visualize_plan']:
            ...
            visualize_trajectory(traj_for_viz, turn_problem.contact_scene['thumb'], viz_fpath, turn_problem.fingers,
...
if __name__ == "__main__":
    ...
    asset = f'{ALLEGRO_MODEL_DIR}/allegro_xela_right.urdf'
    ee_names = {
    ...
    config['obj_dof'] = np.sum(env.obj_dof_code)
